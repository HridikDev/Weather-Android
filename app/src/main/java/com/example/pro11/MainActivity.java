package com.example.pro11; // Use your correct package name
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String API_KEY = "xxxx"; // ⬇️ PASTE YOUR API KEY HERE ⬇️
        ...
        call.enqueue(new Callback<WeatherResponse>() {
            ...
            public void onResponse(@NonNull Call<WeatherResponse> call, @NonNull Response<WeatherResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Toast.makeText(MainActivity.this, "Could not find location. Please try again.", Toast.LENGTH_LONG).show();
                }
            }
